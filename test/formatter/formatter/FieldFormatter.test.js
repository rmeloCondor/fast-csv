...
const FieldFormatter = require('../../../lib/formatter/formatter/FieldFormatter');

describe('FieldFormatter', () => {
    describe('#format', () => {
        const createFormatter = (formatterOptions = {}, headers = null) => {
        ...
        const formatField = (field, fieldIndex, isHeader, fieldFormatter) => fieldFormatter
