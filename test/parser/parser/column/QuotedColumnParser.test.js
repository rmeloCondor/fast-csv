...
const { QuotedColumnParser } = require('../../../../lib/parser/parser/column');
const Scanner = require('../../../../lib/parser/parser/Scanner');

describe('QuotedColumnParser', () => {
    const itemFormatter = col => col;
    const parse = (
        line,
        hasMoreData = false,
        parserOpts = { },
        ...
        const columnParser = new QuotedColumnParser({ parserOptions, columnFormatter });
    ...
    describe('#parse', () => {
        describe('with default delimiter', () => {
            it('should return the same scanner if there is no data', () => {
                ...
                const lineParser = new QuotedColumnParser({ parserOptions, itemFormatter });
