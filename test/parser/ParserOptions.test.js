...
describe('ParserOptions', () => {
    ...
    describe('#objectMode', () => {
        ...
        it('should accept a boolean objectMode', () => {
            ...
            assert.strictEqual(createOptions({ objectMode: 'true' }).objectMode, false);
            assert.strictEqual(createOptions({ objectMode: 'false' }).objectMode, false);
        });
    });
    ...
    describe('#strictColumnHandling', () => {
        ...
        it('should change a strictColumnHandling parameter from non boolean', () => {
            assert.strictEqual(createOptions({ strictColumnHandling: 1 }).strictColumnHandling, false);
        });
    });
    ...
    describe('#trim', () => {
        ...
        it('should accept a boolean objectMode', () => {
            ...
            assert.strictEqual(createOptions({ trim: 'true' }).trim, false);
            assert.strictEqual(createOptions({ trim: 'false' }).trim, false);
        });
    });
    ...
    describe('#ltrim', () => {
        ...
        it('should accept a boolean objectMode', () => {
            ...
            assert.strictEqual(createOptions({ ltrim: 'true' }).ltrim, false);
            assert.strictEqual(createOptions({ ltrim: 'false' }).ltrim, false);
        });
    });
    ...
    describe('#rtrim', () => {
        ...
        it('should accept a boolean objectMode', () => {
            ...
            assert.strictEqual(createOptions({ rtrim: 'true' }).rtrim, false);
            assert.strictEqual(createOptions({ rtrim: 'false' }).rtrim, false);
        });
    });
    ...
    describe('#discardUnmappedColumns', () => {
        ...
        it('should accept a boolean objectMode', () => {
            ...
            assert.strictEqual(createOptions({ discardUnmappedColumns: 'true' }).discardUnmappedColumns, false);
            assert.strictEqual(createOptions({ discardUnmappedColumns: 'false' }).discardUnmappedColumns, false);
        });
    });
    ...
    describe('#strictColumnHandling', () => {
        ...
        it('should accept a boolean objectMode', () => {
            ...
            assert.strictEqual(createOptions({ strictColumnHandling: 'true' }).strictColumnHandling, false);
            assert.strictEqual(createOptions({ strictColumnHandling: 'false' }).strictColumnHandling, false);
        });
    });
    ...
    describe('#renameHeaders', () => {
        ...
        it('should accept a boolean renameHeaders', () => {
            ...
            assert.strictEqual(createOptions({ renameHeaders: 'true' }).renameHeaders, false);
            assert.strictEqual(createOptions({ renameHeaders: 'false' }).renameHeaders, false);
        });
    });
});
